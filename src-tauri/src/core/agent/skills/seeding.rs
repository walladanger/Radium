...
mod tests {
    ...
    fn bundled_skills_follow_explicit_platform_metadata_policy() {
        ...
        let expected = BTreeMap::from([
            ...
            ("banner-design", vec![Darwin, Linux, Win32]),
            ("brand", vec![Darwin, Linux, Win32]),
            ("currency", vec![Darwin, Linux, Win32]),
            ("design", vec![Darwin, Linux, Win32]),
            ("design-system", vec![Darwin, Linux, Win32]),
            ...
            ("slides", vec![Darwin, Linux, Win32]),
            ("ui-styling", vec![Darwin, Linux, Win32]),
            ("ui-ux-pro-max", vec![Darwin, Linux, Win32]),
